...
plt.show()
#
# # Create a bar chart to visualize Application Mode
# plt.figure(figsize=(8, 6))
# sns.countplot(x='Application mode', hue='Target', data=data)
# plt.title('Application Mode vs. Dropout Status')
...
# plt.show()
#
# # Create a bar chart to visualize Application Order
# plt.figure(figsize=(8, 6))
# sns.countplot(x='Application order', hue='Target', data=data)
# plt.title('Application Order vs. Dropout Status')
...
# plt.show()
#
# # Create a bar chart to visualize Course
# plt.figure(figsize=(12, 6))
# sns.countplot(x='Course', hue='Target', data=data)
# plt.title('Course vs. Dropout Status')
# plt.xlabel('Course')
# plt.ylabel('Count')
# plt.legend(title='Dropout Status', loc='upper right', labels=['Dropout', 'Enrolled', 'Graduate'])
...
# plt.show()
#
# # Create a bar chart to visualize Daytime/Evening Attendance
# plt.figure(figsize=(8, 6))
# sns.countplot(x='Daytime/evening attendance', hue='Target', data=data)
# plt.title('Daytime/Evening Attendance vs. Dropout Status')
...
# plt.show()
#
# # Create a bar chart to visualize Previous Qualification
# plt.figure(figsize=(8, 6))
# sns.countplot(x='Previous qualification', hue='Target', data=data)
# plt.title('Previous Qualification vs. Dropout Status')
...
# Create a bar chart to visualize Mother's Occupation
plt.figure(figsize=(12, 6))
sns.countplot(x='Mother\'s occupation', hue='Target', data=data)
plt.title("Mother's Occupation vs. Dropout Status")
